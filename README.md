...
[![Build Status](https://travis-ci.org/silkedit/conan-breakpad.svg?branch=master)](https://travis-ci.org/silkedit/conan-breakpad)
[![Build status](https://ci.appveyor.com/api/projects/status/m5clq0qwkt36x5w7?svg=true)](https://ci.appveyor.com/project/shinichy/conan-breakpad)
...
```
[requires]
breakpad/1.0.0@silkedit/stable
